...
export REWARD_MODEL_PATH="NiuTrans/GRAM-LLaMA3.2-3B-RewardModel"
export MODEL_TYPE="llama" # 'llama', 'gemma', or 'qwen'. Used for generating heuristics.

# Parameters
export PROJECT_ROOT="$(pwd)"
export OUTPUT_DIR="${PROJECT_ROOT}/data/outputs/run_2025-07-20_11-19"
export NUM_SEEDS=8
export NUM_GPUS=8
...
pkill -f "sglang_router.*${REWARD_MODEL_PATH}" || true
wait || true
